...
class GFFDataLine(TabDataLine):
    ...
    @property
    def type(self):
        """Type (pragma, comment, annotation).

        associated with the GFF data line
        'type' is either None, or one of the module-level constants PRAGMA,
        COMMENT, ANNOTATION, indicating the type of data held by the line.
        """
        return self.__type
