...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_NSIS_MUI_ICON "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release\\CMakeLogo.ico")
  set(CPACK_NSIS_MUI_UNIICON "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release\\CMakeLogo.ico")
  # set the package header icon for MUI
  set(CPACK_PACKAGE_ICON "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release\\CMakeInstall.bmp")
  # tell cpack to create links to the doc files
  set(CPACK_NSIS_MENU_LINKS
    "doc/cmake-3.6/html/index.html" "CMake Documentation"
    "https://cmake.org" "CMake Web Site"
    )
  # Use the icon from cmake-gui for add-remove programs
  set(CPACK_NSIS_INSTALLED_ICON_NAME "bin\\cmake-gui.exe")

  set(CPACK_NSIS_PACKAGE_NAME "CMake 3.6.0")
  set(CPACK_NSIS_DISPLAY_NAME "CMake 3.6.0, a cross-platform, open-source build system")
...
include("/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Source/QtDialog/QtDialogCPack.cmake" OPTIONAL)
...
if(CPACK_GENERATOR MATCHES "IFW")
  ...
  set(CPACK_IFW_PACKAGE_WINDOW_ICON
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Source/QtDialog/CMakeSetup128.png")
  set(CPACK_IFW_PACKAGE_CONTROL_SCRIPT
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Source/QtIFW/controlscript.qs")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_CMAKE_LICENSES
    "CMake Copyright" "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Copyright.txt"
    )
  ...
  set(CPACK_IFW_COMPONENT_GROUP_TOOLS_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_CTEST_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_CPACK_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_CMAKEXBUILD_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_GROUP_DIALOGS_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_SCRIPT
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Source/QtIFW/CMake.Dialogs.QtGUI.qs")
  set(CPACK_IFW_COMPONENT_CMAKE-GUI_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_CCMAKE_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-MAN_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_SCRIPT
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/CMake.Documentation.SphinxHTML.qs")
  set(CPACK_IFW_COMPONENT_SPHINX-HTML_VERSION "3.6.0")
  ...
  set(CPACK_IFW_COMPONENT_SPHINX-QTHELP_VERSION "3.6.0")
...
if("${CPACK_GENERATOR}" STREQUAL "DragNDrop")
  set(CPACK_DMG_BACKGROUND_IMAGE
      "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Packaging/CMakeDMGBackground.tif")
  set(CPACK_DMG_DS_STORE_SETUP_SCRIPT
      "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Packaging/CMakeDMGSetup.scpt")
endif()
...
if("${CPACK_GENERATOR}" STREQUAL "WIX")
  ...
  set(CPACK_WIX_PRODUCT_ICON
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/CMakeLogo.ico"
  )

  set_property(INSTALL "doc/cmake-3.6/html/index.html" PROPERTY
  ...
  set(CPACK_WIX_UI_BANNER
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/ui_banner.jpg"
  )

  set(CPACK_WIX_UI_DIALOG
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/ui_dialog.jpg"
  )

  set(CPACK_WIX_EXTRA_SOURCES
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/install_dir.wxs"
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/cmake_extra_dialog.wxs"
  )

  set(_WIX_CUSTOM_ACTION_ENABLED "FALSE")
  if(_WIX_CUSTOM_ACTION_ENABLED)
    list(APPEND CPACK_WIX_EXTRA_SOURCES
      "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/cmake_nsis_overwrite_dialog.wxs"
      )
    ...
    if(_WIX_CUSTOM_ACTION_MULTI_CONFIG)
      ...
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/custom_action_dll-${_WIX_CUSTOM_ACTION_CONFIG}.wxs")
    else()
      list(APPEND CPACK_WIX_EXTRA_SOURCES
        "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/custom_action_dll.wxs")
    endif()
  endif()
  ...
  set(CPACK_WIX_PATCH_FILE
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/patch_path_env.xml"
  )

  set(CPACK_WIX_TEMPLATE
    "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/WIX.template.in"
  )
  ...
  if(BUILD_QtDialog)
    list(APPEND CPACK_WIX_PATCH_FILE
      "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Utilities/Release/WiX/patch_desktop_shortcut.xml"
      )
