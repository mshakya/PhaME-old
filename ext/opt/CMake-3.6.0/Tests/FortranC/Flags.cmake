set(src "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Tests/FortranC")
set(bld "/panfs/biopan01/users/312793/PhaME/ext/opt/CMake-3.6.0/Tests/FortranC/Flags")

# Create wrapper scripts for the compilers that check for expected
# flags, remove them, and invoke the real compiler.
set(ID "CC")
set(COMMAND "/cm/local/apps/gcc/5.1.0/bin/gcc")
